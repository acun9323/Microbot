...
@ConfigInformation("Acun <br> 0.1.0-alpha.1 <br><br> Start near GE. <br><br> Make sure to spell item names correct. Collects items to bank. <br> Be cautious and monitor when using, because there are no failsafes added yet."
)
